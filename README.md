...
- applies OpenClaw plugin capability consent only when supported and explicitly confirms the trusted local relay-channel archive, so noninteractive image preparation works across pre-consent and consent-aware OpenClaw releases;
